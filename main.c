...
int main(int argc, char **argv) {
    ...
    // Insert file (-i)
        ...
        if (argc != 4) {
            printf("Usage: %s -i <archive_name> <filename>\n", argv[0]);
            return 1;
        }
    ...
    // Delete file (-d)
        ...
        if (argc != 4) {
            printf("Usage: %s -d <archive_name> <filename>\n", argv[0]);
            return 1;
        }
    ...
    // Extract file (-x)
        ...
        if (argc != 4) {
            printf("Usage: %s -x <archive_name> <filename>\n", argv[0]);
            return 1;
        }
